...
class NewAppsIconsDialog(val activity: Activity) {
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_new_apps_icons, null).apply {
            ...
            val smsMessengerUrl = "https://play.google.com/store/apps/details?id=com.pearltools.smsmessenger"
            val voiceRecorderUrl = "https://play.google.com/store/apps/details?id=com.pearltools.voicerecorder"
