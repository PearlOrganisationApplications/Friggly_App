...
import com.pearltools.commons.models.AlarmSound
import com.pearltools.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.pearltools.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isAProApp() = packageName.startsWith("com.pearltools.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.pearltools."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.pearltools.contacts") && !packageName.startsWith("com.rank.me.dialer")) {
        true
    } else if ((packageName.startsWith("com.pearltools.contacts") || packageName.startsWith("com.rank.me.dialer")) && isQPlus()) {
