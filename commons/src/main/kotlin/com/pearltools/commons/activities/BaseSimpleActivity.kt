package com.pearltools.commons.activities
...
import com.pearltools.commons.asynctasks.CopyMoveTask
import com.pearltools.commons.dialogs.*
import com.pearltools.commons.dialogs.WritePermissionDialog.Mode
import com.pearltools.commons.extensions.*
import com.pearltools.commons.helpers.*
import com.pearltools.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.rank.me", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                ...
                ConfirmationDialog(this, label, positive = R.string.ok, negative = 0) {
                    launchViewIntent("https://google.com")
                }
            }
        }
    }
    ...
    fun setupToolbar(
        ...
        toolbar.background = resources.getDrawable(R.drawable.toolbar_bg)
        ...
        searchMenuItem?.actionView?.findViewById<EditText>(androidx.appcompat.R.id.search_src_text)?.apply {
            ...
            textSize = 14f
            background = resources.getDrawable(R.drawable.toolbar_bg_box)
            hint = getString(R.string.search_for)
            if (isQPlus()) {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.pearltools")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.pearltools.")
