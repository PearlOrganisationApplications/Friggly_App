...
import com.pearltools.commons.dialogs.ConfirmationAdvancedDialog
import com.pearltools.commons.dialogs.RateStarsDialog
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupPrivacyPolicy() {
        ...
        about_privacy_policy_holder.setOnClickListener {
            val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.pearltools.")
