...
import com.rank.me.data.remote.RemoteData
...
class DataRepository @Inject constructor(
    ...
    override suspend fun doRegister(registerRequest: RegisterRequest): Flow<Resource<LoginResponse>> {
        return flow {
            emit(localRepository.doRegister(registerRequest))
        }.flowOn(ioDispatcher)
    }
